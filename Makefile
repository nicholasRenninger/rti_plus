CC = g++
#OPT = -O4 -DNDEBUG -Wall -Wno-deprecated -Wno-sign-compare -L /usr/local/lib/ -I /usr/local/include -lgsl -lgslcblas -lm
...
build/rti: *.cpp
	$(CC) $(OPT) $(CODE) -L /usr/local/lib/ -I /usr/local/include -lgsl -lgslcblas -lm
